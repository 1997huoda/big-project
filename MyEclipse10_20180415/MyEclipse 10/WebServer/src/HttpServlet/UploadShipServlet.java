...
public class UploadShipServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//现在是/image文件夹
		//url：
		//http://pcohd.oicp.io:33667/WebServer/image/share.png
		
		// 获取系统默认的临时文件保存路径，该路径为Tomcat根目录下的temp文件夹
		//F:\Workspaces\MyEclipse 10\.metadata\.me_tcat\webapps\WebServer
...
//			out.write(path);  //这里我把服务端成功后，返回给客户端的是上传成功后路径
			out.write("http://pcohd.oicp.io:33667/WebServer/image/"+Name);
